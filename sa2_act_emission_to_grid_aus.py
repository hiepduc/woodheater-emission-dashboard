...
# Load SA2 shapefile
sa2_gdf = gpd.read_file("/home/duch/whe_dashboard/sa2shape/ACT_Shapefile_SA2/ACT_shape_sa2.shp")
...
csv_files = glob("sa2_act_emission/*_weekday_July*_sa2_ACT_kg.csv")
...
# Save to NetCDF
emission_ds.to_netcdf("gridded_emissions_weekday_July_ACT_aus.nc")
