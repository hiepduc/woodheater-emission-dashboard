...
# Load ACT SA2 shapefile
sa2_gdf = gpd.read_file("/mnt/scratch_lustre/duch/whe_dashboard/sa2shape/NSW_Shapefile_SA2/NSW_shapefile_sa2.shp")
...
# Clip population to ACT bounding box
...
# Process ACT weekday July CSV files
csv_files = glob("sa2_nsw_emission/*_weekday_July_sa2_NSW_KgHr_24Hsum.csv")
...
# Save ACT emissions NetCDF
emission_ds.to_netcdf("gridded_emissions_weekday_July_NSWonly.nc")
