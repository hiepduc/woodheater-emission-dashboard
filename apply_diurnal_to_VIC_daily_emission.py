...
daily_ds = xr.open_dataset("gridded_emissions_weekday_July_VIC.nc")
...
# Save to NetCDF
hourly_ds.to_netcdf("gridded_emissions_weekday_July_VIC_hourly.nc")

print("✅ Hourly emission file created: gridded_emissions_weekday_July_VIC_hourly.nc")
