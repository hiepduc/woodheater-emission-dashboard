...
# Load QLD SA2 shapefile
sa2_gdf = gpd.read_file("/mnt/scratch_lustre/duch/whe_dashboard/sa2shape/QLD_ShapeFile_SA2/QLD_ShapeFile_SA2.shp")
...
# Clip population to QLD bounding box
...
# Process QLD weekday July CSV files
csv_files = glob("sa2_qld_emission/*_weekday_July_sa2_QLD_kg.csv")
...
emission_ds.to_netcdf("gridded_emissions_weekday_July_QLD.nc")
